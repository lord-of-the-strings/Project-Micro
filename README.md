...
This project has been revamped to a new plan. This plan executes in stages. The first stage consistsn following the original FLOPPILINUX tutorial by @w84death to try out the concept without initial hiccups. Meanwhile, the author @lord-of-the-strings is also studying other such implementations especially the famous talk by @iczelia.
